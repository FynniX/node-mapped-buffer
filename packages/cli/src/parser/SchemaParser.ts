...
export default class SchemaParser extends Parser {
	...
	public get literalNames(): (string | null)[] { return SchemaParser.literalNames; }
	public get symbolicNames(): (string | null)[] { return SchemaParser.symbolicNames; }
	public get ruleNames(): string[] { return SchemaParser.ruleNames; }
	public get serializedATN(): number[] { return SchemaParser._serializedATN; }
	...
	public static readonly _serializedATN: number[] = [4,1,34,74,2,0,7,0,2,
	...
	static DecisionsToDFA = SchemaParser._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );
