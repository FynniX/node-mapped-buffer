...
class PathCommandContext extends ParserRuleContext {
    constructor(parser, parent, invokingState) {
        super(parent, invokingState);
        this.parser = parser;
    }
...
export { ArrayContext, DimensionContext, PathCommandContext, PrimitiveTypeContext, SchemaContext, StructContext, TypeContext, UserTypeContext, SchemaParser as default };
